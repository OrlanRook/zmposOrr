...
import { clone, IClient, ClientVoid } from './client.interface';
import { HttpResponse } from '@angular/common/http';
import { NotificationService } from 'src/app/notification.service';

import * as $ from 'jquery';

type dtModel = IClient;
const dtModelVoid = ClientVoid;

const toastTitle    = 'Clientes';
const toastCSuccess = 'Cliente creado correctamente';
const toastCFailure = 'No se pudo crear el cliente';
const toastRSuccess = 'Clientes leidos correctamente';
const toastRFailure = 'Error al obtener la lista de clientes';
const toastUSuccess = 'Cliente actualizado correctamente';
const toastUFailure = 'No se pudo actualizar el cliente';
const toastDSuccess = 'Cliente elimando correctamente';
const toastDFailure = 'No se pudo eliminar el cliente';
